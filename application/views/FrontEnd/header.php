...
<head>
  <title>Merchandise silhouette &mdash;Dealer</title>
  <meta charset="utf-8">
        ...
        <div class="row align-items-center">
          ...
          <div class="col-6 text-left">
            <ul class="social-media">
              <li><a href="https://www.facebook.com/prince.arafath.12" class=""><span class="icon-facebook"></span></a></li>
              <li><a href="https://www.facebook.com/prince.arafath.12" class=""><span class="icon-facebook"></span></a></li>
              <li><a href="https://www.facebook.com/prince.arafath.12" class=""><span class="icon-instagram"></span></a></li>
              <li><a href="https://www.facebook.com/prince.arafath.12" class=""><span class="icon-linkedin"></span></a></li>
            </ul>
          </div>
          <div class="col-6">
            <p class="mb-0 float-right">
              <span class="mr-3"><a href="tel://#"> <span class="icon-phone mr-2" style="position: relative; top: 2px;"></span><span class="d-none d-lg-inline-block text-black">(+880) 17 9433 1671</span></a></span>
              <span><a href="#"><span class="icon-envelope mr-2" style="position: relative; top: 2px;"></span><span class="d-none d-lg-inline-block text-black">merchandiseSilhoutte@gmail.com</span></a></span>
            </p>
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-6 col-xl-2">
            <h2 class="mb-0 site-logo"><a href="<?php echo base_url('home/index') ?>" class="text-black mb-0">Merchandise Silhouette<span class="text-primary">.</span> </a></h2>
          </div>
