...
<div class="container">
        ...
        <div class="modal-body">
          <p> <?php
              if ($this->session->flashdata('order')) {
                echo $this->session->flashdata('order');
              }
              ?></p>
        </div>
  ...
  <div class="row">
    <div class="col-lg-2">
      ...
      <br>
      <center>
        <h2 style="color:black;font-weight: bold;color:#f16821">Product</h2>
      </center>
      <ul class="list-group">
        <?php
        if ($allCategory) {
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <div class="d-none d-lg-block">
              ...
              <br>
              <div class="slide-box">
                <img class="contain image" width="20%" src="<?php echo base_url('assets/img/chips.png') ?>" alt="First slide">
                <img width="20%" src="<?php echo base_url('assets/img/juice.png') ?>">
                <img width="20%" src="<?php echo base_url('assets/img/biscuits.png') ?>" alt="First slide">
                <img width="10%" src="<?php echo base_url('assets/img/chana.png') ?>" alt="First slide">
              </div>
            </div>
          </div>
    ...
    <div class="col-lg-2">
      ...
      <br>
      <center>
        <h2 style="color:black;font-weight: bold;color: #f16821">Brand</h2>
      </center>
      <ul class="list-group">
        <?php
        if ($allBrand) {
